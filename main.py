...
#     'Password': 'cjb1148581147',
    'TextBoxAccount': '1148581147@qq.com',
    'Password': 'cc1148581147',
...
class Crawl:
    ...
    def try_get(self, url, headers, data):
        try:
    ...
    def get_patent(self, patent_header, patent_url, patent_data):
        response = self.try_get(url=patent_url, headers=patent_header, data=patent_data)
#         response = self.session.post(patent_url, headers=patent_header, data=patent_data)
    ...
    def get_state(self, patent_header, appNo):
        ...
        response = self.try_get(url=state_url, headers=patent_header, data=dumpJsonData)
...
def main_batch(NoNumber, ItemCount, kw, userAgent, cookie):
    mk_folder(kw)
    
    headers['User-Agent'] = userAgent
    patentHeader['User-Agent'] = userAgent
    patentHeader['Cookie'] = cookie
